const LOCAL_ICONS = {
  ...
  "map-pin": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>`,
  ...
  "home": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10.489V21a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-10.511"/></svg>`,
  ...
  "pause": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="4" height="16" x="6" y="4"/><rect width="4" height="16" x="14" y="4"/></svg>`,
  ...
  "edit": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>`,
  "save": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/><path d="M9 14h6"/></svg>`,
  ...
  "gift": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="8" x="5" y="14" rx="2"/><rect width="14" height="8" x="5" y="2" rx="2"/><path d="M5 10h14"/><path d="M12 2v8"/></svg>`,
  ...
  "minimize": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6"/><path d="M20 10h-6V4"/><path d="M14 10l7-7"/><path d="M3 21l7-7"/></svg>`,
  ...
  "pie-chart": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>`,
  ...
  "bold": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 12h9a4 4 0 0 1 0 8H7a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h7a4 4 0 0 0 0-8H8a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z"/></svg>`,
  ...
  "align-left": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="6" y2="6"/><line x1="3" x2="15" y1="12" y2="12"/><line x1="3" x2="18" y1="18" y2="18"/></svg>`,
  "align-center": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="6" y2="6"/><line x1="9" x2="15" y1="12" y2="12"/><line x1="5" x2="19" y1="18" y2="18"/></svg>`,
  "align-right": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="6" y2="6"/><line x1="9" x2="21" y1="12" y2="12"/><line x1="6" x2="21" y1="18" y2="18"/></svg>`,
  "move": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9l-3 3 3 3"/><path d="M9 5l3-3 3 3"/><path d="M15 19l-3 3-3-3"/><path d="M19 9l3 3-3 3"/><line x1="2" x2="22" y1="12" y2="12"/><line x1="12" x2="12" y1="2" y2="22"/></svg>`,
  ...
  "whatsapp": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.7 3A7.7 7.7 0 0 0 2 10.7c0 1.8.6 3.5 1.7 4.9L2 22l5.4-1.4A7.7 7.7 0 0 0 15.3 20v0a7.7 7.7 0 0 0-6.6-6.9z"/><path d="M12 7.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z"/><path d="M16.5 11a6.4 6.4 0 0 0-6.3-6.4"/></svg>`,
...
export class IconSearch {
  ...
  _searchLocal(query) {
    ...
    const keywords = {
      '常用': Object.keys(LOCAL_ICONS),
      'social': ['instagram', 'facebook', 'twitter', 'youtube', 'linkedin', 'whatsapp', 'tiktok'],
      'arrow': ['arrow-right', 'arrow-left', 'chevron-down', 'chevron-up', 'external-link', 'move'],
      'ui': ['check', 'x', 'plus', 'minus', 'menu', 'search', 'filter', 'settings', 'home', 'grid', 'list', 'layout', 'layers'],
      'file': ['download', 'upload', 'save', 'copy', 'link', 'external-link', 'trash', 'edit'],
      'media': ['image', 'video', 'camera', 'music', 'play', 'pause', 'eye', 'eye-off'],
      'text': ['type', 'bold', 'italic', 'align-left', 'align-center', 'align-right'],
      'user': ['user', 'users', 'lock', 'unlock'],
      'data': ['bar-chart', 'pie-chart', 'trending-up', 'trending-down', 'target', 'percent', 'dollar-sign'],
      'time': ['calendar', 'clock'],
      'alert': ['alert-triangle', 'check-circle', 'x-circle', 'info', 'bell', 'flag', 'tag', 'zap', 'fire', 'gift'],
      'nature': ['heart', 'star', 'sun', 'moon'],
      'place': ['map-pin', 'globe'],
      'com': ['mail', 'phone', 'message-circle', 'send', 'bookmark'],
    };
    let results = [];
    for (const [cat, icons] of Object.entries(keywords)) {
      if (cat.includes(q) || q.length < 3) {
        results = results.concat(icons);
      }
    }
    results = [...new Set(results)].slice(0, 60);
    return results;
  }
  ...
  async search(query) {
    ...
    const localResults = this._searchLocal(q);
    if (localResults.length) {
      this._results.innerHTML = '<div style="font-size:11px;color:var(--text-muted);margin-bottom:6px;">Ícones locais</div>';
      localResults.forEach(iconId => {
        const btn = document.createElement('button');
        btn.className = 'icon-result-btn';
        btn.innerHTML = `<span style="width:32px;height:32px;display:flex;align-items:center;justify-content:center;color:var(--text-primary);">${LOCAL_ICONS[iconId]}</span><span>${iconId}</span>`;
        btn.addEventListener('click', () => {
          this._onPick?.({ iconId, svg: LOCAL_ICONS[iconId] });
          this.close();
        });
    ...
    try {
      ...
      this._results.innerHTML = '<div style="font-size:11px;color:var(--text-muted);margin-bottom:6px;">在线 Icons API</div>';
      icons.forEach(iconId => {
        const btn = document.createElement('button');
        btn.className = 'icon-result-btn';
        btn.innerHTML = `<img src="https://api.iconify.design/${iconId}.svg?height=32" alt="${iconId}" loading="lazy"><span>${iconId}</span>`;
